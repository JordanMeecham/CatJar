...
class Main
{
  ...
  public void begin()
  {
    ...
    /** Music file comes from <a href="https://www.youtube.com/watch?v=xy_NKN75Jhw">
https://www.youtube.com/watch?v=xy_NKN75Jhw</a> */
    
    String filepath = "BM.wav"; //file to be passed on to play
    music musicObject = new music(); //creates new instance of music
    musicObject.playMusic(filepath); //begins instance of music 
...
public void startCustomerGUI_MVC(MiddleFactory mlf )
  {
    ...
    window.getContentPane().setBackground( Color.gray );  //changes background colour of client
...
/**
  ...
  {
    JFrame  window = new JFrame(); //creates a new JFrame that is shown
    window.getContentPane().setBackground( Color.gray );  //changes background colour
    window.setTitle( "Review Client MVC"); //Sets title of the client
    window.setDefaultCloseOperation( JFrame.EXIT_ON_CLOSE );
    Dimension pos = PosOnScrn.getPos();
    
    ReviewModel model      = new ReviewModel(mlf);
    ReviewView view        = new ReviewView( window, mlf, pos.width, pos.height );
