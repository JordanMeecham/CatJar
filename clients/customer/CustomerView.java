...
public class CustomerView implements Observer
{
  ...
  public CustomerView( RootPaneContainer rpc, MiddleFactory mf, int x, int y )
  {
    ...
    theBtCatalogue.setBounds( 6, 15+60*2, 100, 40 );    //Catalogue Button
    theBtCatalogue.addActionListener(                   //Call back code
      e -> cont.doCatalogue() );                        //will call this method when clicked
    ...
    thePicture.setBounds( 16, 50+32*4, 80, 80 );   // Picture area
